...
// write a function that returns the sum list. The sum 
// list is linked list representation of the addition 
// of two input numbers. It is not allowed to modify the 
